// This is an empty Ballerina class autogenerated to represent the `com.microsoft.azure.storage.SharedAccessAccountPolicy` Java class.
//
...
//               (<class-name>...)
//
// E.g. $ bal bindgen com.microsoft.azure.storage.SharedAccessAccountPolicy
